...
DEFAULT_INPUT="resume-fullstack.md"
DEFAULT_OUTPUT_BASE="Brett_Chapin_Resume_FullStack"
input="$DEFAULT_INPUT"
...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    --help|-h)
      echo "Usage:"
      echo "  ./build_fullstack_resume.sh [--sf] [--font-family <family>]"
      echo "  ./build_fullstack_resume.sh [--sf] [--font-family <family>] <output-base-or-file>"
      echo "  ./build_fullstack_resume.sh [--sf] [--font-family <family>] <input.md> <output-base-or-file>"
      exit 0
      ;;
    *)
      positionals+=("$1")
