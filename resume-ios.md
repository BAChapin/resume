...
**iOS:** Swift, SwiftUI, UIKit, Combine, CoreData, SwiftData, VisionKit, PushKit, CallKit  
**Architecture:** MVVM, VIPER, Clean Architecture, Server-Driven UI  
**Other:** Kotlin, React Native, TypeScript, Firebase, Node.js, Vapor, PostgreSQL, MongoDB, CI/CD (GitLab, Azure, Fastlane, TestFlight)
